...
gdt64:
    dq 0                          ; NULL ディスクリプタ
.code: equ $ - gdt64
    dq (1<<43)|(1<<44)|(1<<47)|(1<<53)  ; 64-bit コードセグメント E(43bit目 実行可能コードセグメント) | S(44bit目 システムではなく通常のコード/データ) | P(47bit目 有効) | L(53bit目 64-bitコード)
.data: equ $ - gdt64
    dq (1<<41)|(1<<44)|(1<<47)          ; データセグメント W(41bit目 書き込み可能) | S(44bit目 システムではなく通常のコード/データ) | P(47bit目 有効)
gdt64_ptr:
    dw $ - gdt64 - 1
